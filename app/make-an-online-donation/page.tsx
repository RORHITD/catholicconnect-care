      ...
      <section className="bg-neutral-50 py-20 lg:py-28">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-2xl bg-cream-50 p-8 ring-1 ring-neutral-200">
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-14 grid gap-7 md:grid-cols-3">
            {ways.map((w) => (
              <article key={w.title} className="rounded-2xl bg-cream-50 p-8 ring-1 ring-neutral-200">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-100 text-brand-700 ring-1 ring-brand-200">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
                    <path d="M12 2v20M5 12h14" strokeLinecap="round" />
                  </svg>
                </div>
                <h3 className="mt-5 text-2xl text-neutral-900">{w.title}</h3>
                <p className="mt-3 leading-relaxed text-neutral-700">{w.body}</p>
              </article>
            ))}
          </div>
          <div className="mt-12 rounded-2xl bg-brand-50 p-8 text-center ring-1 ring-brand-100 sm:p-12">
            <h3 className="text-2xl text-neutral-900 md:text-3xl">
              Request Information To Donate Stocks Or Other Types Of Assets
            </h3>
            <p className="mx-auto mt-4 max-w-3xl leading-relaxed text-neutral-700">
