...
export default function SiteFooter() {
  return (
    <footer className="bg-stone-warm-900 text-cream-100">
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link href="/" className="flex items-center gap-3 mb-4">
              <span className="flex h-12 w-12 items-center justify-center rounded-full bg-burgundy-600 text-cream-50 font-display text-xl font-bold ring-2 ring-gold-400 ring-offset-2 ring-offset-stone-warm-900">
                C
              </span>
            ...
            <div className="mt-5 flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-stone-warm-800 hover:bg-burgundy-600 transition"
              >
          ...
          <div>
            <h3 className="font-display text-base font-semibold text-cream-50">Get Involved</h3>
            <ul className="mt-4 space-y-2.5">
              {getInvolved.map((it) => (
                <li key={it.label}>
                  <Link
                    href={it.href}
                    className="text-sm text-cream-100/80 hover:text-gold-400 transition"
                  >
                    {it.label}
                  </Link>
                </li>
          ...
          <div>
            <h3 className="font-display text-base font-semibold text-cream-50">Ways to Donate</h3>
            <ul className="mt-4 space-y-2.5">
              {waysToDonate.map((it) => (
                <li key={it.label}>
                  <Link
          ...
          <div>
            <h3 className="font-display text-base font-semibold text-cream-50">Contact Us</h3>
            <ul className="mt-4 space-y-2.5 text-sm text-cream-100/80">
              <li>
                <a href="tel:+18322417969" className="hover:text-gold-400 transition">
                  Call or Text: +1 (832) 241-7969
                </a>
              </li>
              <li>The Woodlands, TX 77381</li>
              <li>
                <a href="mailto:contact@catholicconnect.care" className="hover:text-gold-400 transition">
              ...
              <li className="pt-2">
                <Link
                  href="/contact-us"
                  className="inline-flex items-center gap-1.5 text-gold-400 hover:text-gold-300 transition"
                >
                  Send us a message
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-stone-warm-800 pt-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link href="/privacy-policy" className="text-xs text-cream-100/60 hover:text-gold-400 transition">
            Privacy Policy
          </Link>
        </div>
      </div>
